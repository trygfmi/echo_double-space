# python $(find . -type f -maxdepth 2 -name "update_english_article_heading.py")
...
latest_translated_h2=subprocess.run(f"ls -1t {project_root_path}/translate/translated_headings_folder | sed -n '4p'", shell=True, capture_output=True, text=True).stdout.strip()
with open(project_root_path+"/translate/translated_headings_folder/"+latest_translated_h2, "r", encoding="utf-8") as f:
...
latest_translated_h3=subprocess.run(f"ls -1t {project_root_path}/translate/translated_headings_folder | sed -n '3p'", shell=True, capture_output=True, text=True).stdout.strip()
with open(project_root_path+"/translate/translated_headings_folder/"+latest_translated_h3, "r", encoding="utf-8") as f:
    for element, line in zip(elements, f):
        driver.execute_script("""
                            let new_text = arguments[1];
                            arguments[0].textContent = new_text;
...
latest_translated_h4=subprocess.run(f"ls -1t {project_root_path}/translate/translated_headings_folder | sed -n '2p'", shell=True, capture_output=True, text=True).stdout.strip()
with open(project_root_path+"/translate/translated_headings_folder/"+latest_translated_h4, "r", encoding="utf-8") as f:
    for element, line in zip(elements, f):
        driver.execute_script("""
                            let new_text = arguments[1];
                            arguments[0].textContent = new_text;
...
latest_translated_h5=subprocess.run(f"ls -1t {project_root_path}/translate/translated_headings_folder | sed -n '1p'", shell=True, capture_output=True, text=True).stdout.strip()
with open(project_root_path+"/translate/translated_headings_folder/"+latest_translated_h5, "r", encoding="utf-8") as f:
    for element, line in zip(elements, f):
        driver.execute_script("""
                            let new_text = arguments[1];
                            arguments[0].textContent = new_text;
